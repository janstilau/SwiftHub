...
class SettingsViewModel: ViewModel, ViewModelType {
    ...
    override init(provider: SwiftHubAPI) {
        ...
        // SettingViewModel 里面的 bannerEnabled, 根据 LibsManager.shared.bannersEnabled 的值进行初始化.
        ...
        /*
         bannerEnabled 的值的变动, 会绑定到 LibsManager.shared.bannersEnabled 中.
         这样, 本地的修改, 可以触发全局量的修改, 而这个全局量的信号源, 会被多方进行注册, 触发多方的 UI 刷新逻辑.
         */
